[![Build Status](https://travis-ci.org/Yohanson555/gojay.svg?branch=master)](https://travis-ci.org/Yohanson555/gojay)
[![codecov](https://codecov.io/gh/Yohanson555/gojay/branch/master/graph/badge.svg)](https://codecov.io/gh/Yohanson555/gojay)
[![Go Report Card](https://goreportcard.com/badge/github.com/Yohanson555/gojay)](https://goreportcard.com/report/github.com/Yohanson555/gojay)
[![Go doc](http://img.shields.io/badge/go-documentation-blue.svg?style=flat-square
)](https://godoc.org/github.com/Yohanson555/gojay)
![MIT License](https://img.shields.io/badge/license-mit-blue.svg?style=flat-square)
[![Sourcegraph](https://sourcegraph.com/github.com/Yohanson555/gojay/-/badge.svg)](https://sourcegraph.com/github.com/Yohanson555/gojay)
![stability-stable](https://img.shields.io/badge/stability-stable-green.svg)

# GoJay

<img src="https://github.com/Yohanson555/gojay/raw/master/gojay.png" width="200px">
...
There is also a [code generation tool](https://github.com/Yohanson555/gojay/tree/master/gojay) to make usage easier and faster.
...
```bash
go get github.com/Yohanson555/gojay
```

* [Encoder](#encoding)
* [Decoder](#decoding)
* [Stream API](#stream-api)
* [Code Generation](https://github.com/Yohanson555/gojay/tree/master/gojay)
...
```go
import "github.com/Yohanson555/gojay"
...
```bash
cd $GOPATH/src/github.com/Yohanson555/gojay/benchmarks/decoder && make bench
```

To run benchmark for encoder:
```bash
cd $GOPATH/src/github.com/Yohanson555/gojay/benchmarks/encoder && make bench
```
...
### Small Payload
[benchmark code is here](https://github.com/Yohanson555/gojay/blob/master/benchmarks/decoder/decoder_bench_small_test.go)

[benchmark data is here](https://github.com/Yohanson555/gojay/blob/master/benchmarks/benchmarks_small.go)
...
### Medium Payload
[benchmark code is here](https://github.com/Yohanson555/gojay/blob/master/benchmarks/decoder/decoder_bench_medium_test.go)

[benchmark data is here](https://github.com/Yohanson555/gojay/blob/master/benchmarks/benchmarks_medium.go)
...
### Large Payload
[benchmark code is here](https://github.com/Yohanson555/gojay/blob/master/benchmarks/decoder/decoder_bench_large_test.go)

[benchmark data is here](https://github.com/Yohanson555/gojay/blob/master/benchmarks/benchmarks_large.go)
...
### Small Struct
[benchmark code is here](https://github.com/Yohanson555/gojay/blob/master/benchmarks/encoder/encoder_bench_small_test.go)
...
### Medium Struct
[benchmark code is here](https://github.com/Yohanson555/gojay/blob/master/benchmarks/encoder/encoder_bench_medium_test.go)
...
### Large Struct
[benchmark code is here](https://github.com/Yohanson555/gojay/blob/master/benchmarks/encoder/encoder_bench_large_test.go)
